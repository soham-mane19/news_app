...
import 'package:news_app/SportsCon.dart';
...
class Sports extends StatefulWidget {
  ...
  @override
  State createState() => _SportsState();
}

class _SportsState extends State {
  int catindex = 3;
  @override
            ...
            child: FutureBuilder(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  List<SportArticles> articles = snapshot.data.articles;
                  return Padding(
                    padding:
